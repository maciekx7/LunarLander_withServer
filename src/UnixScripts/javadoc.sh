...
javadoc -d $JAVADOC_FOLDER_GAME game game.physic game.Constant game.controller game.data game.interfaces game.launcher game.view game.window game.entities game.configReader game.manager game.serverConnection

#creating javadoc in specyfic folder for all server files
javadoc -d $JAVADOC_FOLDER_SERVER server server.configReader
